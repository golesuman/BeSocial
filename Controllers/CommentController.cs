...
namespace BlogApp.Controllers
{
    ...
    public class CommentController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("CommentId,Content,PostedAt,UserId,PostId")] Comment comment)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("CommentId,Content,PostedAt,UserId,PostId")] Comment comment)
        {
